...
execute if entity @s[team=halfling] unless items entity @s armor.* * run effect give @s speed 1 2 true
execute if entity @s[team=halfling] unless items entity @s armor.* * run effect give @s strength 1 1 true
