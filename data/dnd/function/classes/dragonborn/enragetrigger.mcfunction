...
execute as @e[type=interaction,tag=enrage] on attacker at @s anchored eyes run scoreboard players set @s enraged_status 120

execute as @e[type=interaction,tag=enrage] on attacker run scoreboard players set @s cooldown 300
